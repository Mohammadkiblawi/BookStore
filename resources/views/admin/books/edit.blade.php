...
<div class="row justify-content-center">
    <div class="card mb-4 col-md-8">
        ...
        <div class="card-body">
            <form method="POST" action="{{route('books.show',$book)}}" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                            name="title" value="{{$book->title}}" autocomplete="title">
                        @error('title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="isbn" type="text" class="form-control @error('isbn') is-invalid @enderror"
                            name="isbn" value={{$book->isbn}} autocomplete="isbn">
                        @error('isbn')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="category" class="form-control" name="category">
                            <option disabled {{$book->category== null ? "selected" : ""}}>Choose a Category</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="authors" multiple class="form-control" name="authors[]">
                            <option disabled {{$book->authors()->count() == 0 ? 'selected' : ''}}>Choose Authors
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="as" multiple class="form-control" name="publisher">
                            <option disabled {{$book->publisher == null ? 'selected' : ''}}>Choose a Publisher</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="number_of_copies" type="text"
                            ...
                            value={{$book->number_of_copies}} autocomplete="number_ofnumber_of_copies">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="price" type="text" class="form-control @error('price') is-invalid @enderror"
                            name="price" value={{$book->price}} autocomplete="price">
                        @error('price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
